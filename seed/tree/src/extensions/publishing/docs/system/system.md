...
- The extension's four sections — Channels, Shapes, Deliverables, Standing Items — stand under one icon in the shell's icon column, *Publish*, Phosphor `paper-plane-tilt`, and show as bands with their carets inside it. User decision, 2026-09-18 (`ui.shell`'s `CA_0056`; `CA_0056_010`).
