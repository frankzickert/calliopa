...
export function renderExtension(
  ...
  // An extension's changes are its `docs/changes/` members (`BO_0254`),
  // listed the way its topics are and opened read-only in this view. The
  // network orders them open first, then by identifier.
